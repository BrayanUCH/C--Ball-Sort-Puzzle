...
nivel5::nivel5(int resolucion_x, int resolucion_y, std::string titulo)
{
...
#pragma region Botones
	...
	TXT_nextLevel->setString("Terminar Partida");
	TXT_nextLevel->setPosition(690, 15);
...
void nivel5::colocar_colores_pilas(pila pil, int i)
{
	///
	///1
	///
...
void nivel5::Movimiento_entre_pilas()
{
	///
	///1
	/// 
...
bool nivel5::Pilas_llenas(pila pil)
{
	int i = 0;
...
bool nivel5::GAME_OVER(pila pil)
{
...
void nivel5::MostrarRepeticion(listaMovi listasMostrar)
{
	listaMovi q;
	pila t;
	t = new(struct nodo);
...
void nivel5::GuardarMovimientos()
{
	listaMovi t, q;
	q = new(struct nodoC);
...
void nivel5::regresarPasos(listaMovi& listasMostrar)
{
