...
nivel3::nivel3(int resolucion_x, int resolucion_y, std::string titulo)
{
...
void nivel3::colocar_colores_pilas(pila pil, int i)
{
	///
	///1
	///
...
void nivel3::Movimiento_entre_pilas()
{
	///
	///1
	/// 
...
bool nivel3::Pilas_llenas(pila pil)
{
	int i = 0;
...
bool nivel3::GAME_OVER(pila pil)
{
...
void nivel3::MostrarRepeticion(listaMovi listasMostrar)
{
	listaMovi q;
	pila t;
	t = new(struct nodo);
...
void nivel3::GuardarMovimientos()
{
	listaMovi t, q;
	q = new(struct nodoC);
...
void nivel3::regresarPasos(listaMovi& listasMostrar)
{
